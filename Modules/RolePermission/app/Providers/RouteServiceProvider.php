...
{
    protected string $moduleNamespace = 'Modules\RolePermission\app\Http\Controllers';
    ...
    {
        $path = module_path('RolePermission', '/Routes/Web/');
        $attributes = [
            'as' => 'web.',
    ...
    protected function mapApiRoutes(): void
    {
        ...
        Route::group($attributes, function () {
            $path = module_path('RolePermission', 'Routes/Api/');
